                                        ...
                                        <div class="card card-primary card-outline">
                                            ...
                                            <form action="" method="post" onsubmit="return fetchProducerInfo();">
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="txtproducteur_code" name="txtproducteur_code"
                                                                required placeholder="Tapez le code du producteur..."
                                                ...
                                                ?>
                                                        ...
                                                        <input type="hidden" id="txtsecteur_name"
                                                            name="txtsecteur_name">

                                                        <div class="form-group col-md-6">
                                                            <label for="txtdepartement">Département</label>
                                                            <input type="text" class="form-control"
                                                                name="txtdepartement" id="txtdepartement" required
                                                                maxlength="225">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="txtsous_prefecture" id="txtsous_prefecture"
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                name="txtsuperficie_hectares"
                                                                id="txtsuperficie_hectares" step="0.00001" required>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                ...
                                                                id="txtproduction_annuelle_estimee" step="0.00001"
                                                                required>
                                                        </div>
                                                    </div>
